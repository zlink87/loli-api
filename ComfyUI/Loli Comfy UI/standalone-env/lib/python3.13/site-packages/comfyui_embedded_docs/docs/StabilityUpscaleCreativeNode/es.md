...
Escala imágenes con alteraciones mínimas a resolución 4K. Este nodo utiliza la tecnología de escalado creativo de Stability AI para mejorar la resolución de la imagen mientras preserva el contenido original y añade detalles creativos sutiles.
...
| `creatividad` | FLOAT | Sí | 0.1-0.5 | Controla la probabilidad de crear detalles adicionales no fuertemente condicionados por la imagen inicial. (valor por defecto: 0.3) |
| `estilo predefinido` | COMBO | Sí | Múltiples opciones disponibles | Estilo opcional deseado para la imagen generada. Las opciones incluyen varios preajustes de estilo de Stability AI. |
