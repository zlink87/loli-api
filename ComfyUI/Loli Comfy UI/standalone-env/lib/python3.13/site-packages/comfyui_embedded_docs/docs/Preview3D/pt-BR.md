...
O nó Preview3D é utilizado principalmente para visualizar saídas de modelos 3D. Este nó recebe duas entradas: uma é a `camera_info` do nó Load3D, e a outra é o caminho para o arquivo do modelo 3D. O caminho do arquivo do modelo deve estar localizado na pasta `ComfyUI/output`.
...
A área da Tela inclui várias operações de visualização, como:
...
- Clique esquerdo + arrastar: Rotacionar a visualização
- Clique direito + arrastar: Mover a visualização
- Rolar a roda do meio ou clique do meio + arrastar: Aproximar/afastar
...
- 3. Câmera: Alternar entre visualização ortográfica e em perspectiva, definir ângulo de perspectiva
...
Este menu fornece a alternância entre visualizações ortográfica e em perspectiva, e configurações do tamanho do ângulo de perspectiva:

1. **Câmera**: Alternar rapidamente entre visualizações ortográfica e em perspectiva
